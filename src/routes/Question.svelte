    ...
    question_list: [
      {
        ...
        difficulty: "easy",
        options:
          "a) урбанизация<br>b) адаптация<br> c) миграция<br> d) инфляция",
      },
      {
        id: 1,
        text: "Как называется ежедневное перемещение людей из городов-спутников в центр агломерации для выполнения рабочих функция, посещения культурных объектов и т.д.?",
        correct_answer: "c) миграция",
        difficulty: "easy",
        options:
          "a) урбанизация<br>b) эмансипация<br> c) миграция<br> d) трансформация ",
      },
      {
        id: 2,
        ...
        difficulty: "easy",
        options:
          "a) Самарская<br>b) Новосибирская<br> c) Московская<br> d) Нижегородская",
      },
      {
        id: 3,
        ...
        difficulty: "easy",
        options:
          "a) областной центр<br>b) городская агломерация<br> c) городище<br> d) село",
      },
      {
        id: 4,
        ...
        difficulty: "easy",
        options:
          "a) Хашури – Зестафони<br>b) Кизел – Чусовая<br> c) Баку – Сураханы<br> d) Москва – Мытищи",
      },
      {
        id: 5,
        ...
        difficulty: "easy",
        options:
          "a) Москва – Серпухов<br>b) Кизел – Чусовая<br> c) Москва – Мытищи<br> d) Ленинград – Бологое",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        difficulty: "easy",
        options:
          "a) Ртищево<br>b) Кочетовка<br> c) Санкт-Петербург-Сортировочный-Московский<br> d) Георгиу-Деж",
      },
      {
        id: 8,
      ...
      },
      {
        ...
        difficulty: "easy",
        options:
          "a) Виндавский<br>b) Ржевский<br> c) Псковский<br> d) Балтийский",
      },
      {
        id: 10,
      ...
      {
        id: 12,
        text: "Какие предприятия нельзя выносить из города?",
        correct_answer: "c)  Стратегические",
        difficulty: "easy",
        options:
          "a)  Тактические<br>b)  Оперативные<br> c)  Стратегические<br> d)  Нормативные",
      },
      {
        id: 13,
      ...
      },
      {
        ...
        difficulty: "easy",
        options:
          "a) если поезд следует в границах одного субъекта РФ<br>b) если поезд следует из столицы одного субъекта РФ в столицу соседнего субъекта<br> c) если маршрутная скорость поезда составляет более 50 км/ч<br> d) пригородные поезда не могут следовать на расстояния более 200 километров",
      },
      {
        id: 16,
        text: "Как по графику движения поездов определить потребный парк подвижного состава?",
        correct_answer:
          "b) провести вертикальную линию на графике движения и посчитать количество её пересечений с нитками",
        difficulty: "easy",
        options:
          "a) потребный парк равен количеству ниток в одном направлении<br>b) провести вертикальную линию на графике движения и посчитать количество её пересечений с нитками<br> c) провести горизонтальную линию на графике движения и посчитать количество её пересечений с нитками<br> d) по графику движения невозможно определить потребный парк подвижного состава",
      },
      {
        id: 17,
        text: "Как можно решить проблемы предприятий, находящихся в городе?",
        correct_answer: "b)  Вынести предприятие за территорию города",
        difficulty: "easy",
        options:
          "a)  Снести застройку вокруг<br>b)  Вынести предприятие за территорию города<br> c)  Уволить рабочих<br> d)  Закрыть предприятие",
      },
      {
        id: 18,
      ...
      },
      {
        ...
        difficulty: "easy",
        options:
          "a) процесс движения поезда в определённом рейсе<br>b) процесс оборота в пункте оборота<br> c) техническое обслуживание составов<br> d) технологический перерыв в движении поездов",
      },
      {
        id: 20,
        text: "Какие сложности возникают у предприятий, находящихся в городе?",
        correct_answer: "d)  Все вышеперечисленное",
        difficulty: "easy",
        options:
          "a) Стоимость земли, на которой располагаются такие производства, чаще всего намного превышает стоимость активов самого предприятия<br>b) Возникают трудности с доставкой сырья для изготовления продукции и вывозом готовой продукции<br> c)  Повышенные экологические требования в городах требуют от предприятий дополнительных затрат<br> d)  Все вышеперечисленное",
      }
    ],
  };
