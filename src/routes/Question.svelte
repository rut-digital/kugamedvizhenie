<script>
  ...
  {
        id: 23,
        text: 'Тип расписания движения, при котором обеспечиваются постоянные интервалы в течении всего периода, называется…',
  ...
  {
        id: 26,
        text: 'Как называется разновидность неавтономного подвижного состава для прогородных перевозок, получающего энергию, как правило, от внешней контактной сети или от собственных аккумуляторных батарей?',
