<script>
  ...
  const QUESTION_LIST = {
    question_list: [{
        id: 0,
        text: 'Какое количество пикетных столбиков усатанвливается в пределах одного километра жд-линии?',
        correct_answer: 'в) 9',
        difficulty: 'medium',
      ...
      },
{
        ...
        difficulty: 'medium',
        options: 'а) Северомуский тоннель <br> б) Тоннель под Амуром <br> в) Байкальский тоннель <br> г) Адлер - Красная Поляна'
      },
{
        id: 3,
      ...
      },
{
        ...
        correct_answer: 'в) Три: лунно-белый (используется на маневровых светофорах), молочно-белый (используется на стрелочных указателях), прозрачно-белый (используется в ручных фонарях)',
        difficulty: 'medium',
        options: 'а) Один: лунно-белый <br> б) Два: лунно-белый, молочно-белый <br> в) Три: лунно-белый, молочно-белый, прозрачно-белый <br> г) Четыре: лунно-белый, молочно-белый, прозрачно-белый, облачно-белый'
      },
{
        id: 5,
        ...
        options: 'а) Поездной светофор <br> б) Локомотивный светофор <br> в) Повторительный светофор <br> г) Контрольная лампа'
      },
{
        id: 6,
        ...
        options: 'а) Пылесос <br> б) Металлоискатель <br> в) Кусторез <br> г) Поливомоечная'
      },
{
        id: 7,
        ...
        options: 'а) Петарда <br> б) Кнопка <br> в) Счетчик осей <br> г) Вагонный замедлитель'
      },
{
        id: 8,
        text: 'Что изображено на фотографии?',
        ...
        options: 'а) Сбрасывающий башмак <br> б) Сбрасывающий остряк <br> в) Сбрасывающая стрелка <br> г) Обрыв рельсовой нити'
      },
{
        id: 9,
        ...
        difficulty: 'easy',
        image: 'https://storage.yandexcloud.net/rzd-universitet/image_2023-08-18_17-52-08.png',
      ...
      },
{
        ...
        difficulty: 'easy',
        options: 'а) Блок-посты <br> б) Блок-участки <br> в) Главные пути <br> г) Рельсовые плечи'
      },
{
        id: 11,
        ...
        difficulty: 'easy',
        options: 'а) Один <br> б) Два <br> в) Три <br> г) От одного до пяти в зависимости от межпоездного интервала'
      },
{
        id: 12,
        ...
        options: 'а) Главный выключатель <br> б) Реактор <br> в) Реостат <br> г) Пантограф'
      },
{
        id: 13,
      ...
      },
{
        ...
        options: 'а) Щебнеочиститель <br> б) Пылесос <br> в) Струг, снегоочиститель <br> г) Бронетранспортер'
      },
{
        id: 16,
        ...
        options: 'а) Сварочный поезд <br> б) Подбивочно-рихтовочный состав <br> в) Рельсошлифовальный поезд <br> г) Передвижная рельсоплавильная станция'
      },
{
        id: 17,
        ...
        difficulty: 'easy',
        options: 'а) Вагон-лаборатория <br> б) Вагон-дефектоскоп <br> в) Вагон-путеизмеритель <br> г) Турный вагон'
      },
{
        id: 18,
        text: 'Как называется элемент выемки: земляной вал правильной призматической формы из грунта, изъятого из выемки и не использованного при возведении насыпи? ',
        correct_answer: 'а) Кавальер',
        difficulty: 'hard',
        image: 'https://storage.yandexcloud.net/rzd-universitet/image_2023-08-18_18-24-56.png',
      ...
      },
{
        ...
        difficulty: 'hard',
        options: 'а) Калининградская область <br> б) Еврейский АО <br> в) Республика Саха-Якутия <br> г) Сахалинская область'
      },
{
        id: 20,
      ...
      },
{
        ...
        options: 'а) Консольная <br> б) Анкерная <br> в) Фидерная <br> г) Питающая'
      },
{
        id: 25,
      ...
      },
{
        ...
        difficulty: 'hard',
        options: 'а) Руководящий <br> б) Решающий <br> в) Критический <br> г) Скоростной'
      },
],
  };
  ...
  const next = () => {
    ...
    const writeQuestion = () => {
      ...
      answerOptions = splitString(QUESTION_LIST.question_list[randomQuestionId].options);
...
<div class="tablet">
  ...
  <div class="tablet__element tablet__element_answer">
    <div class="tablet__text tablet__text_correctanswertitle">Правильный ответ:</div>
