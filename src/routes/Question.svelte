<script>
      ...
      },
  {
        ...
        correct_answer: 'c) маятниковая миграция',
        difficulty: 'easy',
        options: 'a) урбанизация<br>b) депопуляция<br> c) маятниковая миграция<br> d) трансформация '
      },
  {
        id: 2,
  ...
  // {
  //       id: 16,
  //       text: 'Как по графику движения поездов определить потребный парк электропоездов в пригородном сообщении?',
  ...
  {
        id: 21,
        text: 'Участок железной дороги в Москве до 2016 года с преобладанием грузового движения, а после 2016 года — с преобладанием пассажирского движения',
        correct_answer: 'b) Московское центральное кольцо (Малое кольцо МЖД)',
        difficulty: 'easy',
        options: 'a) Рижское направление<br>b) Московское центральное кольцо (Малое кольцо МЖД)<br> c) Казанское направление<br> d) Московские центральные диаметры'
      },
  {
        id: 22,
  ...
  {
        id: 26,
        text: 'Как называется разновидность неавтономного подвижного состава постоянного формирования для пригородных перевозок, получающего энергию, как правило, от внешней контактной сети или от собственных аккумуляторных батарей?',
